...
(function () {
  ...
  var _COMP_NATURE   = { heading: 'Trois ingrédients, pas un de plus.', ings: [ { pct: 72, origin: 'Lauzerte · Quercy', name: 'Châtaigne', desc: 'Variété « Marigoule », ramassée à la main, cuite à l\'eau, épluchée à la veillée.' }, { pct: 26, origin: 'Île de la Réunion', name: 'Sucre roux', desc: 'Sucre de canne non raffiné, à la mélasse intacte. Cuisson lente.' }, { pct: 2, origin: 'France · eau de source', name: 'Eau', desc: 'Eau de source, rien d\'autre.' } ], restDesc: 'Sans gluten · sans huile de palme · sans pectine · sans conservateur.' };
  var _COMP_VANILLEE = { heading: 'Trois ingrédients, pas un de plus.', ings: [ { pct: 65, origin: 'Lauzerte · Quercy', name: 'Châtaigne', desc: 'Variété « Marigoule », cueillie à la main, cuite doucement.' }, { pct: 27, origin: 'Île de la Réunion', name: 'Sucre roux', desc: 'Sucre de canne non raffiné, à la mélasse intacte. Cuisson lente.' }, { pct: 2, origin: 'Madagascar', name: 'Vanille Bourbon', desc: 'Gousse fendue à la main, infusée à froid pendant 48h dans le sirop.' } ], restDesc: 'Sans gluten · sans huile de palme · sans pectine · sans conservateur.' };
  var _COMP_NOISETTE = { heading: 'Deux ingrédients, pas un de plus.', ings: [ { pct: 60, origin: 'Piémont · Italie', name: 'Noisettes', desc: 'Torréfiées à la main, 30 min à sec, sans huile ajoutée.' }, { pct: 40, origin: 'Lauzerte · Quercy', name: 'Châtaigne', desc: 'Châtaignes confites, cuites doucement au sucre roux.' } ], restDesc: 'Sans gluten · sans huile de palme · sans sucre ajouté · sans conservateur.' };
  ...
  var _COMP_COFFRET  = { heading: 'Trois crèmes signatures,', ings: [ { pct: 100, origin: 'Quercy · France', name: 'Crèmes artisanales', desc: 'Sélection de 3 pots fabriqués à Lauzerte.' } ], restDesc: 'Boîte bois gravée · emballage cadeau inclus · livraison soignée.' };
